    ...
    <el-form ref="LVForm"  :model="LVForm" label-width="80px" style="width:50%" :rules="LVFormRules"></br>
      ...
      <el-card class="box-card" style="width:100%" body-style  >
          ...
          <el-form-item  v-show="willshow" >
            <a>标题：</a>
            <el-input type="text" style="width:100%" v-model="LVForm.vote.title[i]" auto-complete="off" placeholder="投票标题"></el-input>
            <el-radio class="radio" v-model="LVForm.vote.radio[i]" label="单选">单选</el-radio>
            <el-radio class="radio" v-model="LVForm.vote.radio[i]" label="多选">多选</el-radio>
          </el-form-item>
